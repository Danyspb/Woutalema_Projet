 ...
 */
final class Version20210901143224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE publication (id INT AUTO_INCREMENT NOT NULL, etat_id INT DEFAULT NULL, discussion_id INT DEFAULT NULL, service_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, zone_id INT DEFAULT NULL, date_publication DATE NOT NULL, INDEX IDX_AF3C6779D5E86FF (etat_id), INDEX IDX_AF3C67791ADED311 (discussion_id), INDEX IDX_AF3C6779ED5CA9E6 (service_id), INDEX IDX_AF3C6779F347EFB (produit_id), INDEX IDX_AF3C67799F2C3FAB (zone_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, prestataire_id INT DEFAULT NULL, livreur_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, telephone INT NOT NULL, email VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, numero_cni BIGINT NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), UNIQUE INDEX UNIQ_8D93D64919EB6921 (client_id), UNIQUE INDEX UNIQ_8D93D649BE3DB2B7 (prestataire_id), UNIQUE INDEX UNIQ_8D93D649F8646701 (livreur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
